...
////        ResponseDTO responseDTO = client.sendRequest(new URIBuilder(URI.create("https://pro-api.coinmarketcap.com/v2")) .build());
//
...
//        CoinMarketCapClient client = new CoinMarketCapClient("key");
//        URI uri = client.buildURIv2(List.of(new BasicNameValuePair("key", "value")), "/crypto");
//
